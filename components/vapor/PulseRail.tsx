...
export function PulseRail({ className }: PulseRailProps) {
  ...
  // Show actual friends only - no mock data in staging/production
  const displayFriends = sortedFriends
    ...
    <div className={cn("px-4 py-3 vapor-canvas", className)}>
      <div className="flex gap-4 overflow-x-auto scrollbar-hide pb-1">
        ...
        {displayFriends.length > 0 ? (
          ...
          <>
            {/* Empty state: Find Athletes CTA */}
            <Link
              href="/discover"
              className="flex flex-col items-center gap-1.5 shrink-0"
            >
              <div className="w-16 h-16 rounded-full bg-orange-50 border-2 border-orange-200 flex items-center justify-center hover:bg-orange-100 transition-colors">
                <span className="text-xl">🔍</span>
              </div>
              <span className="text-[10px] font-medium text-orange-600 text-center truncate w-16">
                Find athletes
              </span>
            </Link>
            {/* Invite Friends CTA */}
            <Link
              ...
              className="flex flex-col items-center gap-1.5 shrink-0"
            >
              <div className="w-16 h-16 rounded-full bg-indigo-50 border-2 border-indigo-200 flex items-center justify-center hover:bg-indigo-100 transition-colors">
                <span className="text-xl">📨</span>
              </div>
              <span className="text-[10px] font-medium text-indigo-600 text-center truncate w-16">
                Invite friends
              </span>
            </Link>
          </>
