...
export function LandingSocialProof() {
  ...
  return (
    <section className="w-full py-14 sm:py-16 lg:py-20 bg-slate-50 overflow-hidden" data-testid="landing-social-proof">
      <div className="container px-4 sm:px-6 mx-auto max-w-7xl">
        ...
        <div className="text-center mb-8 sm:mb-10">
          <h2 className="text-[clamp(24px,4vw,36px)] font-bold text-slate-900 tracking-[-0.01em] mb-2">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="relative bg-white rounded-2xl border border-slate-200 shadow-lg p-5 sm:p-8 overflow-hidden">
            {/* Quote Icon */}
            <Quote className="absolute top-4 right-4 w-12 h-12 text-orange-100" />
            ...
            <div className="relative grid md:grid-cols-3 gap-5 items-center">
              ...
              <div className="md:col-span-1">
                <div className="flex flex-col items-center text-center">
                  <Avatar className="h-16 w-16 border-2 border-white shadow-md mb-3">
                    <AvatarImage src={testimonials[activeIndex].avatar} />
                    <AvatarFallback className="text-lg bg-slate-900 text-white">
                  ...
                  <div className="text-xs text-slate-400">{testimonials[activeIndex].location}</div>
                  ...
                  {/* Highlight Badge */}
                  <div className="mt-3 px-3 py-1.5 bg-slate-900 text-white rounded-full text-xs font-bold">
              ...
              <div className="md:col-span-2">
                <blockquote className="text-base sm:text-lg text-slate-700 leading-relaxed font-medium">
                  &ldquo;{testimonials[activeIndex].quote}&rdquo;
                </blockquote>
                <div className="mt-4 flex items-center gap-2">
                  <span className="px-2.5 py-1 bg-orange-100 text-orange-600 rounded-full text-xs font-bold">
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={index}
              className="text-center p-4 bg-white rounded-xl border border-slate-200 shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all"
            >
              <div className="text-2xl md:text-3xl font-bold text-slate-900 mb-0.5">
                {stat.value}
              </div>
              <div className="font-semibold text-sm text-slate-600">{stat.label}</div>
